                ...
                if (batchFiles.length > 0) {
                  ...
                  try {
                    ...
                    if (batchResult && typeof batchResult.analysis_text === 'string' && batchResult.analysis_text.trim()) {
                      ...
                      // Нормализуем markdown-таблицу: добавляем перевод строки между заголовком и строкой-разделителем,
                      // если они слиплись в одну строку (как в некоторых ответах ikap3).
                      // Пример до:
                      //   | ... | НДС в зачет (превышение) | |---------|---...
                      // Пример после:
                      //   | ... | НДС в зачет (превышение) |
                      //   |---------|---...
