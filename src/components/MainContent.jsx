      ...
      <div className="content-container">
        ...
        <div className="progress-steps">
          {[
            ...
            { key: 'taxes', label: 'Налоги', hint: 'Загрузите налоговую отчетность за текущий и предыдущий год в формате PDF.' },
            { key: 'financial', label: 'Фин. отчет', hint: 'Загрузите финансовую отчетность (баланс и ОПУ) за текущий и предыдущий год в формате Excel (XLSX).' }
          ].map(item => (
            <StepBadge
              key={item.key}
              label={item.label}
